...
data class AppSettings(
    ...
    // 基岩版 GDK/Proton 设置
    val bedrockProtonPath: String = "",     // 自定义 Proton 路径（空=自动）
    val bedrockProtonAutoInstall: Boolean = true, // 首次启动时自动安装 ProtonGDK
    val bedrockDownloadChunkCount: Int = 4, // 基岩版下载并发数
    val bedrockEnableVersionIsolation: Boolean = true,
    val bedrockShowDownloadedPrompt: Boolean = true,
